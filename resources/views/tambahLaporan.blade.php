...
<div class="container-fluid py-4">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-8" style="padding-left: 0; margin-left: -75px;">
                ...
                <div class="card-body px-5 py-4">
                    ...
                    <form action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tgl_dibuat" id="tgl_dibuat" class="form-control @error('tgl_dibuat') is-invalid @enderror" value="{{ old('tgl_dibuat') }}" required>
                            @error('tgl_dibuat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <textarea name="desk_lap" id="desk_lap" class="form-control @error('desk_lap') is-invalid @enderror" rows="5" required>{{ old('desk_lap') }}</textarea>
                            @error('desk_lap')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
