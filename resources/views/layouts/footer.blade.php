        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer-logo-area">
                    ...
                    <p>Jelajahi dunia berita dengan Kabelat App! Dapatkan berita terkini, baca Program Dispusip, dan
                        tetap terhubung dengan informasi terbaru.</p>
                    <ul>
                ...
                <div class="footer-logo-area1">
                    ...
                    <ul>
                        ...
                        @foreach ($programs as $program)
                            @if ($programCount < 5)
                                <li><a
                                        href="{{ route('programdispusip.detail', $program->kd_program) }}">{{ $program->nm_program }}</a>
                                </li>
                            @endif
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-logo-area1">
                    <h3>Komunitas</h3>
                    <ul>
                        @php $communityCount = 0; @endphp
                        @foreach ($komunitasList as $komunitas)
                            @if ($communityCount < 10)
                                <li><a
                                        href="{{ route('komunitas.detail', $komunitas->kd_komunitas) }}">{{ $komunitas->nm_komunitas }}</a>
                                </li>
                            @endif
                            @php $communityCount++; @endphp
                        @endforeach
                    </ul>
                </div>
            </div>
